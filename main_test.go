...
func TestPhonebook(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			names:   []string{"Deniss B", "Deniss B", "Deniss B", "Deniss B", "Deniss B"},
			numbers: []string{"+37127785804", "+37127785804", "+37127785804", "+37127785804", "+37127785804"},
			want:    map[string]string{"Deniss B": "+37127785804"},
		},
		{
			name:    "empty",
			names:   nil,
